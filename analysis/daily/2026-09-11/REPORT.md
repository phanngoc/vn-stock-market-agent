...
*Sinh tự động bởi [`run_analysis.py`](../run_analysis.py) — mọi số liệu là kết quả tính thật, out-of-sample. Dữ liệu giá tới 2026-09-11 (vnstock/VCI).*

## 1. Thiết lập

- **Vũ trụ cổ phiếu:** 38 mã thanh khoản (VN30-heavy, nhiều ngành).
- **Dữ liệu:** giá ngày 2018-08-02 → 2026-09-11 (sau khi bỏ ~1 năm đầu để 'làm nóng' chỉ báo); huấn luyện < 2025-01-01, **kiểm định out-of-sample ≥ 2025-01-01**.
- **Lưu ý nhãn:** nhãn triple-barrier cần 25 phiên tương lai để 'chốt', nên backtest OOS chỉ tính được tới **2026-08-04**; ~25 phiên gần nhất (tới 2026-09-11) được **chấm điểm live** ở mục 3 nhưng chưa thể backtest.
...
|---|---|---|---|---|---|---|---|
| **LogReg** | 0.5482 | 0.4199 | 0.36% | 0.072 | 238.19% | -264.99% | 662 |
| XGBoost | 0.5338 | 0.4141 | 0.32% | 0.064 | 213.04% | -213.46% | 669 |
| RandomForest | 0.5379 | 0.4025 | 0.04% | 0.008 | 25.97% | -408.17% | 636 |
| GradBoost | 0.5362 | 0.3913 | -0.03% | -0.007 | -22.32% | -443.85% | 667 |
| LSTM | 0.5178 | 0.3773 | -0.03% | -0.005 | -14.62% | -371.44% | 538 |

- **Base win-rate** (vào mọi phiên, không lọc) trên tập kiểm định: **0.357** (breakeven ≈ 0.385 do R:R = 8:5).
- **Buy & hold** trung bình các mã trong kỳ kiểm định: **39.33%** (tham chiếu, không phải cùng cơ sở rủi ro).
...
## 3. Tín hiệu swing hiện tại (as-of 2026-09-11)
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | **PNJ** | Retail/Consumer | 37,900 | 0.6248 | 40,932 | 36,005 | 44 | ↓ dưới MA50 | 0.34 |
| 2 | **VIC** | RealEstate | 247,500 | 0.6023 | 267,300 | 235,125 | 66 | ↑ trên MA50 | 0.13 |
| 3 | **GVR** | Materials | 31,550 | 0.5576 | 34,074 | 29,972 | 51 | ↑ trên MA50 | 0.37 |
| 4 | **VRE** | RealEstate | 25,850 | 0.5416 | 27,918 | 24,558 | 52 | ↑ trên MA50 | 0.29 |
| 5 | **GAS** | Energy | 85,000 | 0.5226 | 91,800 | 80,750 | 62 | ↑ trên MA50 | 0.38 |
| 6 | **PDR** | RealEstate | 11,750 | 0.5093 | 12,690 | 11,162 | 37 | ↓ dưới MA50 | 0.57 |
| 7 | **SSI** | Securities | 20,650 | 0.487 | 22,302 | 19,617 | 52 | ↑ trên MA50 | 0.55 |
| 8 | **FPT** | Technology | 73,200 | 0.4668 | 79,056 | 69,540 | 58 | ↑ trên MA50 | 0.49 |
| 9 | **FRT** | Retail/Consumer | 137,800 | 0.4644 | 148,824 | 130,910 | 50 | ↑ trên MA50 | 0.23 |
| 10 | **DGC** | Materials | 47,050 | 0.4629 | 50,814 | 44,698 | 62 | ↑ trên MA50 | 0.71 |
...
- **Thời gian ra hàng (chốt lời):** thoát khi **chạm +8%** (mục tiêu chốt lời), hoặc **cắt lỗ tại −5%**, hoặc **hết 25 phiên (~5 tuần)** thì thoát theo giá thị trường. Trong backtest, thời gian giữ trung bình ≈ 6.6 phiên.
- **Khung 3 tháng:** với time-stop ~5 tuần, một mã có thể cho **2–3 nhịp sóng** trong 3 tháng tới (từ 2026-09-11 đến ~2026-12-11). Danh sách nên **cập nhật lại hàng tuần** khi có dữ liệu mới.
...
*Tổng quan top 6 tín hiệu.* Chart từng mã: [`PNJ`](charts/PNJ_setup.png), [`VIC`](charts/VIC_setup.png), [`GVR`](charts/GVR_setup.png), [`VRE`](charts/VRE_setup.png), [`GAS`](charts/GAS_setup.png), [`PDR`](charts/PDR_setup.png).
...
*Chạy lại: `cd analysis && python run_analysis.py`. Tạo lúc dữ liệu 2026-09-11.*
