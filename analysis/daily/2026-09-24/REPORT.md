...
*Sinh tự động bởi [`run_analysis.py`](../run_analysis.py) — mọi số liệu là kết quả tính thật, out-of-sample. Dữ liệu giá tới 2026-09-24 (vnstock/VCI).*

## 1. Thiết lập

- **Vũ trụ cổ phiếu:** 38 mã thanh khoản (VN30-heavy, nhiều ngành).
- **Dữ liệu:** giá ngày 2018-08-02 → 2026-09-24 (sau khi bỏ ~1 năm đầu để 'làm nóng' chỉ báo); huấn luyện < 2025-01-01, **kiểm định out-of-sample ≥ 2025-01-01**.
- **Lưu ý nhãn:** nhãn triple-barrier cần 25 phiên tương lai để 'chốt', nên backtest OOS chỉ tính được tới **2026-08-17**; ~25 phiên gần nhất (tới 2026-09-24) được **chấm điểm live** ở mục 3 nhưng chưa thể backtest.
...
|---|---|---|---|---|---|---|---|
| **LogReg** | 0.549 | 0.4237 | 0.40% | 0.079 | 267.06% | -264.99% | 675 |
| XGBoost | 0.5351 | 0.4126 | 0.30% | 0.059 | 201.44% | -208.16% | 681 |
| RandomForest | 0.5389 | 0.4069 | 0.08% | 0.016 | 52.40% | -381.67% | 639 |
| LSTM | 0.519 | 0.3838 | 0.08% | 0.016 | 44.05% | -349.13% | 542 |
| GradBoost | 0.5385 | 0.392 | -0.02% | -0.003 | -10.78% | -428.91% | 671 |

- **Base win-rate** (vào mọi phiên, không lọc) trên tập kiểm định: **0.356** (breakeven ≈ 0.385 do R:R = 8:5).
- **Buy & hold** trung bình các mã trong kỳ kiểm định: **35.91%** (tham chiếu, không phải cùng cơ sở rủi ro).
...
## 3. Tín hiệu swing hiện tại (as-of 2026-09-24)
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | **GAS** | Energy | 84,200 | 0.5495 | 90,936 | 79,990 | 51 | ↑ trên MA50 | 0.34 |
| 2 | **PNJ** | Retail/Consumer | 34,100 | 0.5359 | 36,828 | 32,395 | 34 | ↓ dưới MA50 | 0.60 |
| 3 | **VIC** | RealEstate | 230,500 | 0.5155 | 248,940 | 218,975 | 47 | ↑ trên MA50 | 0.23 |
| 4 | **KDH** | RealEstate | 15,700 | 0.4825 | 16,956 | 14,915 | 33 | ↓ dưới MA50 | 0.32 |
| 5 | **GVR** | Materials | 33,000 | 0.467 | 35,640 | 31,350 | 61 | ↑ trên MA50 | 1.44 |
| 6 | **FRT** | Retail/Consumer | 139,300 | 0.4606 | 150,444 | 132,335 | 56 | ↑ trên MA50 | 0.41 |
| 7 | **VRE** | RealEstate | 24,300 | 0.458 | 26,244 | 23,085 | 39 | ↓ dưới MA50 | 0.52 |
| 8 | **VCI** | Securities | 20,000 | 0.4381 | 21,600 | 19,000 | 41 | ↓ dưới MA50 | 0.33 |
| 9 | **VHM** | RealEstate | 65,600 | 0.4365 | 70,848 | 62,320 | 32 | ↓ dưới MA50 | 1.03 |
| 10 | **POW** | Utilities | 12,600 | 0.4214 | 13,608 | 11,970 | 39 | ↓ dưới MA50 | 0.24 |
...
- **Khung 3 tháng:** với time-stop ~5 tuần, một mã có thể cho **2–3 nhịp sóng** trong 3 tháng tới (từ 2026-09-24 đến ~2026-12-24). Danh sách nên **cập nhật lại hàng tuần** khi có dữ liệu mới.
- **Bối cảnh (quan trọng):** 6/10 mã trong top đang **dưới MA50** (xu hướng giảm) → phần lớn là kèo **hồi kỹ thuật / bắt đáy** (mean-reversion), rủi ro cao hơn kèo momentum. Ai ngại 'bắt dao rơi' nên ưu tiên mã *trên MA50* hoặc chờ nến xác nhận đảo chiều.
...
*Tổng quan top 6 tín hiệu.* Chart từng mã: [`GAS`](charts/GAS_setup.png), [`PNJ`](charts/PNJ_setup.png), [`VIC`](charts/VIC_setup.png), [`KDH`](charts/KDH_setup.png), [`GVR`](charts/GVR_setup.png), [`FRT`](charts/FRT_setup.png).

**Quy tắc chạy thật trong quá khứ** — GAS: mỗi ▲ là một điểm mô hình từng ra tín hiệu (**xanh = thắng**, chạm +8% trước; **đỏ = thua**), theo đúng luật TP/SL/time-stop:
![GAS history](charts/GAS_history.png)
...
*Chạy lại: `cd analysis && python run_analysis.py`. Tạo lúc dữ liệu 2026-09-24.*
